...
function IndexPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IndexPage.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$c92d61ad$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(auth, {
                "IndexPage.useEffect.unsubscribe": async (user)=>{
                    if (!user) {
                        router.push("/login");
                        return;
                    }
                    const userDoc = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$client$5d$__$28$ecmascript$29$__["doc"])(db, "users", user.uid));
                    if (!userDoc.exists()) {
                        alert("사용자 정보가 없습니다.");
                        return;
                    }
            ...
            }["IndexPage.useEffect.unsubscribe"]);
            return ({
                "IndexPage.useEffect": ()=>unsubscribe()
            })["IndexPage.useEffect"];
        }
...
_s(IndexPage, "+gdBHa1gbW9Mmc3iF6LvDTPtsos=", false, function() {
    return [
